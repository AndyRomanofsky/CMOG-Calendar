...
* 
* @createdate Friday, May 17, 2013 - 9:39:43 AM
* @filename view.html.php
* @folder \cmogcal\site\views\bydatereadings
*/
 ...
 * BydateReadings View
 */
class CmogCalViewBydateReadings extends JViewLegacy
{
        protected $items;
        ...
        protected function setDocument() 
        {
                ...
                $document->setTitle(JText::_('Readings by date'));
        }
}