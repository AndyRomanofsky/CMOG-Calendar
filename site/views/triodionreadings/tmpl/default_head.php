...
* 
* @createdate Friday, May 17, 2013 - 9:57:31 AM
...
<?php	} else {   ?>
	<a href="<?php 
	echo JRoute::_('index.php?option=com_cmogcal&view=triodionreadings');
...
<ul> 
    ...
    <li>Select <b><font color="red">"Tridion Readings"</font></b> for movable date readings before Pascha.</li>
