...
* 
* @createdate Tuesday, May 14, 2013 - 4:12:42 PM
* @filename view.html.php
* @folder \cmogcal\site\views\allfixedreadings
*/
...
/**
 * AllfixedReadings View
 */
class CmogCalViewAllfixedReadings extends JViewLegacy
{
        protected $items;
        ...
        protected function setDocument() 
        {
                ...
                $document->setTitle(JText::_('All Fixed Readings'));
        }
}