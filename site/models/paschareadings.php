...
* 
* @createdate Tuesday, May 21, 2013 - 8:33:00 AM
* @filename paschareadings.php
...
class CmogCalModelPaschaReadings extends JModelList
{
        /**
		...
		if(empty($this->_order[0])) {
            ...
            $this->setState('filter_order', $this->_order[0]);
          	...
          	$this->setState('filter_search', $this->_filter_search);
				...
				$query->where('a.gmd = -5 and a.Class = "read" ');
