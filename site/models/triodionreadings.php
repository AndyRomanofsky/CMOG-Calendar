...
/**
* @package CMOGCAL
* @subpackage Triodion Readings
* @copyright Copyright Andrew W Romanofsky - 
*                      Orthodox Church of the Mother of God
*                      Mays Landing NJ. All rights reserved.
* @license GNU General Public License version 2 or later.
* 
* @createdate Monday, May 20, 2013 - 2:35:20 PM
* @filename triodionreadings.php
* @folder \com_cmogcal.0.2.x\cmogcal\site\models
*/
...
class CmogCalModelTriodionReadings extends JModelList
{
        /**
