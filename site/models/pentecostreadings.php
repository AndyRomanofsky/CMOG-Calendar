...
* 
* @createdate Tuesday, May 21, 2013 - 8:28:20 AM
* @filename pentecostreadings.php
...
class CmogCalModelPentecostReadings extends JModelList
{
        /**
        ...
        public function getDisplayWeeks()
		{
		  // Create a new query object.           
				...
				$query->where('a.gmd = -3 and a.Class = "read" ');
