 ...
 *******************************************************************************
 */
function cmog_top_menu($addtype = 0 ){
...
function cmog_render_days_list_page(){
	if ( !current_user_can( 'manage_options' ) )  	{
		wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
	} 
/** *************************** RENDER Events list PAGE ********************************
...
*/
    //Create an instance of our package class...
    $Events_List = new CMOG_Days_List_Table();
    //Fetch, prepare, sort, and filter our data...
    $Events_List->prepare_items(); 
	if( 'edit' === $Events_List->current_action() | 'add' === $Events_List->current_action()) RETURN;
	if( 'Calendar' === $Events_List->current_action()) {
...
function cmog_render_readings_list_page(){
	if ( !current_user_can( 'manage_options' ) )  	{
		wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
	} 
/** *************************** RENDER Events list PAGE ********************************
...
*/
    //Create an instance of our package class...
    $Events_List = new CMOG_Readings_List_Table();
    //Fetch, prepare, sort, and filter our data...
    $Events_List->prepare_items(); 
	if( 'edit' === $Events_List->current_action() | 'add' === $Events_List->current_action()) RETURN;
	if( 'Calendar' === $Events_List->current_action()) {
...
function cmog_render_xceptions_list_page(){
	if ( !current_user_can( 'manage_options' ) )  	{
		wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
	} 
/** *************************** RENDER Events list PAGE ********************************
...
*/
    //Create an instance of our package class...
    $Events_List = new CMOG_Exceptions_List_Table();
    //Fetch, prepare, sort, and filter our data...
    $Events_List->prepare_items(); 
	if( 'edit' === $Events_List->current_action() | 'add' === $Events_List->current_action()) RETURN;
	if( 'Calendar' === $Events_List->current_action()) {
