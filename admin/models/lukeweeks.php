...
* 
* @createdate Friday, April 12, 2013 - 1:36:50 PM
* @filename lukeweeks.php
* @folder C:\Documents and Settings\andy ctr romanofsky\My Documents\joomla\com_cmogcal.0.2.x\cmogcal\admin\models
*/
 ...
 * LukeWeeksList Model
 */
class CmogCalModelLukeWeeks extends JModelList
{
        /**
		...
		protected function populateState($ordering = null, $direction = null)
	{
		...
		$access = $this->getUserStateFromRequest($this->context.'.access', 'filter_access', 0, 'int');
		$this->setState('filter.access', $access);
