 ...
 * PaschaWeek Model
 */
class CmogCalModelPaschaWeek extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($type = 'PaschaWeek', $prefix = 'CmogCalTable', $config = array()) 
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_cmogcal.paschaweek', 'paschaweek',
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_cmogcal.edit.paschaweek.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
        ...
        /**
         * Method to check if it's OK to delete a paschaweek. Overwrites JModelAdmin::canDelete
         */
        protected function canDelete($record)
        {
            if( !empty( $record->ID ) ){
                $user = JFactory::getUser();
                return $user->authorise( "core.delete", "com_cmogcal.paschaweek." . $record->ID );
            }
        }
	/**	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ **/
		/**
