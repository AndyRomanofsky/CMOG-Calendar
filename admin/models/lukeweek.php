 ...
 * LukeWeek Model
 */
class CmogCalModelLukeWeek extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($type = 'LukeWeek', $prefix = 'CmogCalTable', $config = array()) 
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_cmogcal.lukeweek', 'lukeweek',
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_cmogcal.edit.lukeweek.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
        ...
        /**
         * Method to check if it's OK to delete a lukeweek. Overwrites JModelAdmin::canDelete
         */
        protected function canDelete($record)
        {
            if( !empty( $record->ID ) ){
                $user = JFactory::getUser();
                return $user->authorise( "core.delete", "com_cmogcal.lukeweek." . $record->ID );
            }
        }
	/**	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ **/
		/**
