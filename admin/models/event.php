 ...
 * Event Model
 */
class CmogCalModelEvent extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($type = 'Event', $prefix = 'CmogCalTable', $config = array()) 
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_cmogcal.event', 'event',
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_cmogcal.edit.event.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
        ...
        /**
         * Method to check if it's OK to delete an event. Overwrites JModelAdmin::canDelete
         */
        protected function canDelete($record)
        {
            if( !empty( $record->ID ) ){
                $user = JFactory::getUser();
                return $user->authorise( "core.delete", "com_cmogcal.event." . $record->ID );
            }
        }
	/**	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ **/
		/**
