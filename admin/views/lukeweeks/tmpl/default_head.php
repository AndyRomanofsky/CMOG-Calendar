...
* 
* @createdate Monday, April 29, 2013 - 3:01:23 PM
...
<tr class="sortable">
        ...
        <th>
     <?php echo JHTML::_( 'grid.sort', 'COM_CMOGCAL_LUKE_HEADING_EVENTTEXT', 'EventText', $this->sortDirection, $this->sortColumn); ?>
        </th>
     ...
     <?php echo JHTML::_( 'grid.sort', 'JPUBLISHED', 'published', $this->sortDirection, $this->sortColumn); ?>
        ...
        <th width="5%">
     <?php echo JHTML::_( 'grid.sort', 'COM_CMOGCAL_LUKE_HEADING_WEEK', 'week', $this->sortDirection, $this->sortColumn); ?>
        </th>                 
        <th width="5%">
     <?php echo JHTML::_( 'grid.sort', 'COM_CMOGCAL_LUKE_HEADING_WDAY', 'wday', $this->sortDirection, $this->sortColumn); ?>
        </th>               
        <th width="10%">
     <?php echo JHTML::_( 'grid.sort', 'JCATEGORY', 'category_title', $this->sortDirection, $this->sortColumn); ?>
        ...
        <th width="5%">
     <?php echo JHTML::_( 'grid.sort', 'COM_CMOGCAL_LUKE_HEADING_ID', 'ID', $this->sortDirection, $this->sortColumn); ?>
     </th>