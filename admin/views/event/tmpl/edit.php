...
* 
* @createdate Thursday, April 18, 2013 - 2:16:33 PM
* @filename edit.php
* @folder cmogcal\admin\views\event\tmpl
*/
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_cmogcal&view=event&layout=edit&ID='.(int) $this->item->ID); ?>"
