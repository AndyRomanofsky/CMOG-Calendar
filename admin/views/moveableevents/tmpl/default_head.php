...
* 
* @createdate Thursday, May 09, 2013 - 8:58:08 AM
...
<tr class="sortable">
        ...
        <th>
     <?php echo JHTML::_( 'grid.sort', 'COM_CMOGCAL_MOVEABLE_HEADING_EVENTTEXT', 'EventText', $this->sortDirection, $this->sortColumn); ?>
        </th>   
     ...
     <?php echo JHTML::_( 'grid.sort', 'JPUBLISHED', 'published', $this->sortDirection, $this->sortColumn); ?>
        ...
        <th width="5%">
     <?php echo JHTML::_( 'grid.sort', 'COM_CMOGCAL_MOVEABLE_HEADING_OFFSET', 'Offset', $this->sortDirection, $this->sortColumn); ?>
        </th>                 
        <th width="5%">
     <?php echo JHTML::_( 'grid.sort', 'COM_CMOGCAL_MOVEABLE_HEADING_LENGTH', 'Length', $this->sortDirection, $this->sortColumn); ?>
        </th>             
        <th width="10%">
     <?php echo JHTML::_( 'grid.sort', 'JCATEGORY', 'category_title', $this->sortDirection, $this->sortColumn); ?>
        ...
        <th width="5%">
     <?php echo JHTML::_( 'grid.sort', 'COM_CMOGCAL_MOVEABLE_HEADING_ID', 'ID', $this->sortDirection, $this->sortColumn); ?>
     </th>