...
?>
<form action="<?php echo JRoute::_('index.php?option=com_cmogcal&view=moveableevent&layout=edit&ID='.(int) $this->item->ID); ?>"
      method="post" name="adminForm" id="cmogcal-form" class="form-validate">
 
       <div class="width-60 fltlft">
        <fieldset class="adminform">
                <fieldset class="adminform">
                        <legend><?php echo JText::_( 'COM_CMOGCAL_MOVEABLE_DETAILS' ); ?></legend>
